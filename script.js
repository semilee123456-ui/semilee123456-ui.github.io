...
function calcTakeHome(amount, country, stateCode){
  if (country === 'us') {
    ...
    return {
      ...
      val2: laAdditionalTaxWon > 0 ? '-' + laEffectivePct.toFixed(1) + '%' : pickLang('0원', '₩0', '0元', '0 KRW', '0 วอน', '0 вон', { km:'0 វอน', ne:'₩0', id:'₩0', my:'၀ ဝမ်း', si:'0 වොන්', uz:'0 von', mn:'0 вон', kk:'0 вон', ky:'0 вон', ur:'0 وون', bn:'০ ওন', lo:'0 ວອນ', ja:'0ウォン', ar:'0 وون', hi:'₩0', fr:'0 KRW' }),
...
function updateFlexBox(finalEok, country){
  ...
  document.getElementById('flex-apt').textContent = apt.toLocaleString(localeStr) + pickLang('채', ' units', '套', ' căn', ' หลัง', ' шт.', { km:'ខ្នង', ne:'वटा', id:' unit', my:' လုံး', si:'ක්', uz:' ta', mn:' айл', kk:' пәтер', ky:' батир', ur:' یونٹس', bn:'টি', lo:' ຫຼັງ', ja:'戸', ar:' وحدة', hi:' यूनिट', fr:' logements' });
  document.getElementById('flex-car').textContent = car.toLocaleString(localeStr) + pickLang('대', ' cars', '辆', ' chiếc', ' คัน', ' шт.', { km:'គ្រឿង', ne:'वटा', id:' unit', my:' စီး', si:'ක්', uz:' ta', mn:' машин', kk:' көлік', ky:' машина', ur:' گاڑیاں', bn:'টি', lo:' ຄັນ', ja:'台', ar:' سيارة', hi:' गाड़ियाँ', fr:' voitures' });
  document.getElementById('flex-coffee').textContent = coffeeYears > 0
    ...
    : coffeeCups.toLocaleString(localeStr) + pickLang('잔', ' cups', '杯', ' ly', ' แก้ว', ' чашек', { km:'ពែង', ne:'कप', id:' cangkir', my:' ခွက်', si:'ක්', uz:' finjon', mn:' аяга', kk:' кесе', ky:' чыны', ur:' کپ', bn:'কাপ', lo:' ຈອກ', ja:'杯', ar:' كوب', hi:' कप', fr:' tasses' });
}
...
// 비교 카드 그룹핑 노트("N개국 실수령액 동일")의 17개 언어 템플릿 — updateSideBySide()에서 씀
